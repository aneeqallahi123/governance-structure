    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          desc: { type: "string", description: "1-3 sentence description of the body's mandate" },
          abbr: { type: "string", description: "Short abbreviation, e.g. 'PITB'" },
          site: { type: "string", description: "Official website domain, no protocol, e.g. 'pitb.gov.pk'" },
          leads: {
            type: "array",
            items: { type: "string" },
            description: "Leadership lines, e.g. ['Jane Doe — Secretary']",
          },
        },
